...
class DataIngestion:
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifacts:
        ...
        try:
            ...
            # ✅ safe drop (এটাই বসবে এখানে)
            df1 = df.drop(columns=self.data_ingestion_config.DROP_COLS, errors="ignore")
            # optional safe cleaning (better than dropna)
            df1 = df1.fillna(df1.median(numeric_only=True))
            logging.info(f"Shape after cleaning: {df1.shape}")
